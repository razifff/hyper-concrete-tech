...
import { ChevronRight, Truck, Zap, MapPin, Users, CheckCircle, Menu, X } from "lucide-react";
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-border">
            <div className="container py-4 space-y-3">
              <a href="/" className="block text-base font-medium hover:text-primary transition-colors py-2" onClick={() => setMobileMenuOpen(false)}>Home</a>
